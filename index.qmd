...
> **See [Events](events/index.qmd) for a list of included events and their characteristics.**
...
You can:
- add new events following the [data collection protocol](doc/protocol.qmd)
- improve metadata
